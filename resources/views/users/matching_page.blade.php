...
<!--マッチング成立している場合は「このユーザーは既にマッチングが成立しているユーザーです。」の表示にする-->
@if(!empty($matching_each))
<div class="text-center last_row">
    <br>
    ...
    <br>
      ...
      @endforeach
@else
<!--まだマッチング成立していないがマッチング希望者がいる場合は表示する-->
<div class="container">
            <div class="row">
                @foreach ($requests as $user) 
                  <div class="col-md-12">
                      <div class="card text-center hover mt-3 mb-3">
                           <div class="card-header">
                                   ...
                                   <div class="trim center">
                                     <img src="{{$user->file}}" alt="">
                                       ...
                                       <div class="card-text">
                                         ...
                                         {!! Form::close() !!}
                                         <p class="red_font">※一度押したボタンは取り消しができませんので、よく確認の上ボタンを押してください。
                                         </p>
                                       </div>
                               </div> 
                           </div>
